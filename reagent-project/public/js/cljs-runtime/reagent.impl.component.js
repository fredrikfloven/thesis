...
if((i < len)){
var k = (ks[i]);
var G__48979 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__48980 = (i + (1));
m = G__48979;
i = G__48980;
continue;
...
var temp__5722__auto__ = p.argv;
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__48863 = p.children;
return module$node_modules$react$index.Children.toArray(G__48863);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__48865 = c;
var G__48865__$1 = (((G__48865 == null))?null:G__48865.prototype);
if((G__48865__$1 == null)){
return null;
} else {
return G__48865__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__48868 = c;
var G__48868__$1 = (((G__48868 == null))?null:G__48868.prototype);
if((G__48868__$1 == null)){
return null;
} else {
return G__48868__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__48985__delegate = function (args){
var G__48875 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__48875) : reagent.impl.component.as_element.call(null,G__48875));
};
var G__48985 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__48986__i = 0, G__48986__a = new Array(arguments.length -  0);
while (G__48986__i < G__48986__a.length) {G__48986__a[G__48986__i] = arguments[G__48986__i + 0]; ++G__48986__i;}
  args = new cljs.core.IndexedSeq(G__48986__a,0,null);
} 
return G__48985__delegate.call(this,args);};
G__48985.cljs$lang$maxFixedArity = 0;
G__48985.cljs$lang$applyTo = (function (arglist__48987){
var args = cljs.core.seq(arglist__48987);
return G__48985__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__48876 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__48877 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__48877;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__48876;
}});
...
return ((function (G__48884,G__48884__$1){
...
var c = this;
var G__48889_49002 = goog.object.get(c,"cljsRatom");
if((G__48889_49002 == null)){
} else {
reagent.ratom.dispose_BANG_(G__48889_49002);
}
...
var renders_49004 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_49005 = cljs.core.first(cljs.core.vals(renders_49004));
...
if((cljs.core.count(renders_49004) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_49004))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_49005)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_49005], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__48906 = o;
var G__48907_49009 = G__48906;
var G__48908_49010 = cljs.core.name(k);
var G__48909_49011 = v;
goog.object.set(G__48907_49009,G__48908_49010,G__48909_49011);
...
;
var G__48927_49012 = cmp.prototype;
var G__48928_49013 = module$node_modules$react$index.Component.prototype;
var G__48929_49014 = methods$;
goog.object.extend(G__48927_49012,G__48928_49013,G__48929_49014);
...
var name = (function (){var G__48930 = fiber;
var G__48930__$1 = (((G__48930 == null))?null:G__48930.type);
if((G__48930__$1 == null)){
return null;
} else {
return G__48930__$1.displayName;
}
})();
var parent = (function (){var G__48931 = fiber;
if((G__48931 == null)){
return null;
} else {
return G__48931.return;
}
})();
var path = (function (){var G__48932 = parent;
var G__48932__$1 = (((G__48932 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__48932) : reagent.impl.component.fiber_component_path.call(null,G__48932)));
if((G__48932__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48932__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__48934 = c;
if((G__48934 == null)){
return null;
} else {
return goog.object.get(G__48934,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__48935._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__48946 = c;
if((G__48946 == null)){
return null;
} else {
return goog.object.get(G__48946,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__48950 = c;
if((G__48950 == null)){
return null;
} else {
return G__48950._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4131__auto____$1)){
return or__4131__auto____$1;
...
var elem = (function (){var or__4131__auto__ = (function (){var G__48958 = instance;
if((G__48958 == null)){
return null;
} else {
return goog.object.get(G__48958,"_currentElement");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__48963 = instance;
if((G__48963 == null)){
return null;
} else {
return G__48963._currentElement;
}
}
})();
var name = (function (){var G__48964 = elem;
var G__48964__$1 = (((G__48964 == null))?null:G__48964.type);
if((G__48964__$1 == null)){
return null;
} else {
return G__48964__$1.displayName;
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__48966 = elem;
if((G__48966 == null)){
return null;
} else {
return goog.object.get(G__48966,"_owner");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__48969._owner;
}
}
})();
var path = (function (){var G__48970 = owner;
var G__48970__$1 = (((G__48970 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__48970) : reagent.impl.component.component_path.call(null,G__48970)));
if((G__48970__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__48970__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__48971 = c;
var G__48971__$1 = (((G__48971 == null))?null:G__48971.constructor);
if((G__48971__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__48971__$1);
}
}
})();
