...
var G__40513 = devtools.prefs.pref(v);
v = G__40513;
continue;
} else {
return v;
...
}catch (e40459){var _e__39477__auto__ = e40459;
return false;
}})();
...
}catch (e40467){var _e__39477__auto__ = e40467;
return false;
}})();
...
}catch (e40470){var _e__39477__auto__ = e40470;
return false;
}}
}
});
...
var vec__40489 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40489,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40489,(1),null);
...
return cljs.core.some((function (p1__40496_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40496_SHARP_);
}),template);
});
