...
var G__50229_50503 = reagent.impl.template.prop_name_cache;
var G__50230_50504 = cljs.core.name(k);
var G__50231_50505 = v;
goog.object.set(G__50229_50503,G__50230_50504,G__50231_50505);
...
var G__50243 = o;
var G__50244_50510 = G__50243;
var G__50245_50511 = reagent.impl.template.cached_prop_name(k);
var G__50246_50512 = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v));
goog.object.set(G__50244_50510,G__50245_50511,G__50246_50512);
...
return (function() { 
var G__50519__delegate = function (args){
...
while (G__50521__i < G__50521__a.length) {G__50521__a[G__50521__i] = arguments[G__50521__i + 0]; ++G__50521__i;}
  args = new cljs.core.IndexedSeq(G__50521__a,0,null);
} 
return G__50519__delegate.call(this,args);};
G__50519.cljs$lang$maxFixedArity = 0;
G__50519.cljs$lang$applyTo = (function (arglist__50522){
var args = cljs.core.seq(arglist__50522);
return G__50519__delegate(args);
});
...
if((temp__5722__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
var G__50264_50530 = reagent.impl.template.custom_prop_name_cache;
var G__50265_50531 = cljs.core.name(k);
var G__50266_50532 = v;
goog.object.set(G__50264_50530,G__50265_50531,G__50266_50532);
...
var G__50299 = o;
var G__50304_50533 = G__50299;
var G__50305_50534 = reagent.impl.template.cached_custom_prop_name(k);
var G__50306_50535 = reagent.impl.template.convert_prop_value(v);
goog.object.set(G__50304_50533,G__50305_50534,G__50306_50535);
...
var args = null;
if (arguments.length > 0) {
var G__50543__i = 0, G__50543__a = new Array(arguments.length -  0);
while (G__50543__i < G__50543__a.length) {G__50543__a[G__50543__i] = arguments[G__50543__i + 0]; ++G__50543__i;}
  args = new cljs.core.IndexedSeq(G__50543__a,0,null);
} 
return G__50540__delegate.call(this,args);};
G__50540.cljs$lang$maxFixedArity = 0;
G__50540.cljs$lang$applyTo = (function (arglist__50544){
...
var G__50346 = props;
var G__50346__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50346,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50346);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50346__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__50346__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__50355 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50355,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__50355;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__50374){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50375__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__50375,map__50375__$1,on_write){
return (function (){
...
});})(node_value,map__50375,map__50375__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change(this$,on_change,p1__50394_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__50418 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50418,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50418,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50418,(2),null);
...
var temp__5724__auto___50594 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___50594 == null)){
} else {
var key_50597 = temp__5724__auto___50594;
jsprops.key = key_50597;
}
...
var temp__5724__auto___50608 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___50608 == null)){
} else {
var key_50611 = temp__5724__auto___50608;
jsprops.key = key_50611;
}
...
var G__50448 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__50448) : reagent.impl.template.as_element.call(null,G__50448));
} else {
var temp__5724__auto___50622 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___50622 == null)){
} else {
var key_50623 = temp__5724__auto___50622;
jsprops.key = key_50623;
}
...
var G__50452 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__50452)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__50452)){
return x;
} else {
...
var len__4730__auto___50626 = arguments.length;
var i__4731__auto___50627 = (0);
while(true){
if((i__4731__auto___50627 < len__4730__auto___50626)){
args__4736__auto__.push((arguments[i__4731__auto___50627]));

var G__50628 = (i__4731__auto___50627 + (1));
i__4731__auto___50627 = G__50628;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq50456){
var G__50457 = cljs.core.first(seq50456);
var seq50456__$1 = cljs.core.next(seq50456);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50457,seq50456__$1);
});
...
break;
default:
var G__50648 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__50648;
continue;
...
var ctx = ({});
var vec__50491 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50491,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50491,(1),null);
...
var G__50495 = (cljs.core.count(argv) - first_child);
switch (G__50495) {
case (0):
...
break;
case (1):
var G__50496 = component;
var G__50497 = jsprops;
var G__50498 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__50496,G__50497,G__50498);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__50495){
