...
var o40229 = temp__5718__auto__;
var temp__5718__auto____$1 = (o40229["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o40230 = temp__5718__auto____$1;
return (o40230["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39469__auto__ = f;
return (o__39469__auto__["toString"]).call(o__39469__auto__);
} else {
return "";
}
}catch (e40233){var _ = e40233;
return "";
}});
...
try{var o__39469__auto___40437 = t;
(o__39469__auto___40437["cljs$lang$ctorPrWriter"]).call(o__39469__auto___40437,t,writer);
}catch (e40238){var __40438 = e40238;
}
...
var char_code = (function (){var o__39469__auto__ = (new String(char$));
return (o__39469__auto__["charCodeAt"]).call(o__39469__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39469__auto__ = String;
return (o__39469__auto__["fromCharCode"]).call(o__39469__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40248 = num_code;
switch (G__40248) {
case (1):
return (185);
...
var o__39469__auto__ = String;
return (o__39469__auto__["fromCharCode"]).call(o__39469__auto__,superscript_code);
});
/**
...
}catch (e40260){var _e__39477__auto__ = e40260;
return false;
}})())){
...
var vec__40261 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40261,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o40264 = temp__5718__auto__;
var temp__5718__auto____$1 = (o40264["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o40265 = temp__5718__auto____$1;
return (o40265["nameToPath"]);
} else {
return null;
}
} else {
...
var G__40464 = (i__4731__auto___40462 + (1));
i__4731__auto___40462 = G__40464;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40268){
var vec__40269 = p__40268;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40269,(0),null);
...
var G__40474 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__40475 = cljs.core.butlast(remaining_tokens);
name_tokens = G__40474;
remaining_tokens = G__40475;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40266){
var G__40267 = cljs.core.first(seq40266);
var seq40266__$1 = cljs.core.next(seq40266);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40267,seq40266__$1);
});
...
var vec__40275 = cljs.core.split_with((function (p1__40273_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40273_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40275,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40275,(1),null);
...
var vec__40281 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40281,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40281,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__40478 = cljs.core.rest(remaining_tokens);
var G__40479 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__40478;
name_tokens = G__40479;
continue;
} else {
...
var vec__40287 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40287,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40287,(1),null);
var vec__40290 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40290,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40290,(1),null);
var vec__40293 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40293,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40293,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40293,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40293,(3),null);
...
var vec__40299 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40299,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40299,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40299,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40299,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40299,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40299,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__40302 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40302,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40302,(1),null);
var vec__40306 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40306,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40306,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__40319 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__40319) : devtools.munging.parse_fn_info_deep.call(null,G__40319));
})()));
}
} else {
return fn_info;
...
var G__40505 = (arity + (1));
var G__40506 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40320){
var vec__40321 = p__40320;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40321,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40321,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__40328_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__40329_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___40522 = arguments.length;
var i__4731__auto___40523 = (0);
while(true){
if((i__4731__auto___40523 < len__4730__auto___40522)){
args__4736__auto__.push((arguments[i__4731__auto___40523]));

var G__40524 = (i__4731__auto___40523 + (1));
i__4731__auto___40523 = G__40524;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40332){
var vec__40333 = p__40332;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40333,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40330){
var G__40331 = cljs.core.first(seq40330);
var seq40330__$1 = cljs.core.next(seq40330);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40331,seq40330__$1);
});
...
var G__40336 = arg;
var G__40336__$1 = (((G__40336 instanceof cljs.core.Keyword))?G__40336.fqn:null);
switch (G__40336__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40347__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40347__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40347__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40347__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40348 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40348,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40348,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40348,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40348,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40348,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40348,(5),null);
...
var o__39469__auto__ = f;
return (o__39469__auto__["getBasis"]).call(o__39469__auto__);
});
/**
...
}catch (e40357){var _e__39477__auto__ = e40357;
...
var G__40556 = (obj[cljs.core.first(path)]);
var G__40557 = cljs.core.rest(path);
obj = G__40556;
path = G__40557;
continue;
} else {
...
return (function (accum,p__40385){
var vec__40386 = p__40385;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40386,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40386,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40391){
var vec__40392 = p__40391;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40392,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40392,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40392,(2),null);
...
return (function (p__40424){
var vec__40425 = p__40424;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40425,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40425,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__40425,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40397_SHARP_){
return (obj[cljs.core.first(p1__40397_SHARP_)]);
});})(name,sorted_matches,vec__40425,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
