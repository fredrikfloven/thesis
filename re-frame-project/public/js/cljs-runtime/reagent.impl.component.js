...
if((i < len)){
var k = (ks[i]);
var G__50193 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__50194 = (i + (1));
m = G__50193;
i = G__50194;
continue;
...
var temp__5722__auto__ = p.argv;
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__49860 = p.children;
return module$node_modules$react$index.Children.toArray(G__49860);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__49876 = c;
var G__49876__$1 = (((G__49876 == null))?null:G__49876.prototype);
if((G__49876__$1 == null)){
return null;
} else {
return G__49876__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__49887 = c;
var G__49887__$1 = (((G__49887 == null))?null:G__49887.prototype);
if((G__49887__$1 == null)){
return null;
} else {
return G__49887__$1.render;
}
})() == null)))));
});
...
var G__49925 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__49925) : reagent.impl.component.as_element.call(null,G__49925));
};
...
var _STAR_current_component_STAR__orig_val__49931 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__49932 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__49932;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__49931;
}});
...
var G__49940 = key;
var G__49940__$1 = (((G__49940 instanceof cljs.core.Keyword))?G__49940.fqn:null);
switch (G__49940__$1) {
...
return ((function (G__49940,G__49940__$1){
...
var c = this;
var G__49985_50379 = goog.object.get(c,"cljsRatom");
if((G__49985_50379 == null)){
} else {
reagent.ratom.dispose_BANG_(G__49985_50379);
}
...
var renders_50389 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_50390 = cljs.core.first(cljs.core.vals(renders_50389));
...
if((cljs.core.count(renders_50389) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_50389))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_50390)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_50390], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__50060 = o;
var G__50061_50397 = G__50060;
var G__50062_50398 = cljs.core.name(k);
var G__50063_50399 = v;
goog.object.set(G__50061_50397,G__50062_50398,G__50063_50399);
...
;
var G__50082_50401 = cmp.prototype;
var G__50083_50402 = module$node_modules$react$index.Component.prototype;
var G__50084_50403 = methods$;
goog.object.extend(G__50082_50401,G__50083_50402,G__50084_50403);
...
var name = (function (){var G__50098 = fiber;
var G__50098__$1 = (((G__50098 == null))?null:G__50098.type);
if((G__50098__$1 == null)){
return null;
} else {
return G__50098__$1.displayName;
}
})();
var parent = (function (){var G__50099 = fiber;
if((G__50099 == null)){
return null;
} else {
return G__50099.return;
}
})();
var path = (function (){var G__50100 = parent;
var G__50100__$1 = (((G__50100 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__50100) : reagent.impl.component.fiber_component_path.call(null,G__50100)));
if((G__50100__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50100__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__50103 = c;
if((G__50103 == null)){
return null;
} else {
return goog.object.get(G__50103,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__50106._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__50111 = c;
if((G__50111 == null)){
return null;
} else {
return goog.object.get(G__50111,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__50117 = c;
if((G__50117 == null)){
return null;
} else {
return G__50117._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4131__auto____$1)){
return or__4131__auto____$1;
...
var elem = (function (){var or__4131__auto__ = (function (){var G__50130 = instance;
if((G__50130 == null)){
return null;
} else {
return goog.object.get(G__50130,"_currentElement");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__50131 = instance;
if((G__50131 == null)){
return null;
} else {
return G__50131._currentElement;
}
}
})();
var name = (function (){var G__50132 = elem;
var G__50132__$1 = (((G__50132 == null))?null:G__50132.type);
if((G__50132__$1 == null)){
return null;
} else {
return G__50132__$1.displayName;
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__50152 = elem;
if((G__50152 == null)){
return null;
} else {
return goog.object.get(G__50152,"_owner");
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__50154._owner;
}
}
})();
var path = (function (){var G__50155 = owner;
var G__50155__$1 = (((G__50155 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__50155) : reagent.impl.component.component_path.call(null,G__50155)));
if((G__50155__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50155__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__50163 = c;
var G__50163__$1 = (((G__50163 == null))?null:G__50163.constructor);
if((G__50163__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__50163__$1);
}
}
})();
