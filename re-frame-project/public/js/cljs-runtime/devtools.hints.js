...
var G__40214 = cljs.core.PersistentArrayMap.EMPTY;
var G__40215 = native_stack_trace;
var G__40216 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__40217 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__40214,G__40215,G__40216,G__40217) : cljs.stacktrace.parse_stacktrace.call(null,G__40214,G__40215,G__40216,G__40217));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40224__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40224__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40224__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e40222){var _e = e40222;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___40256 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___40256)){
var seen_errors_40257 = temp__5718__auto___40256;
if(cljs.core.truth_(seen_errors_40257.has(self))){
} else {
seen_errors_40257.add(self);

var temp__5720__auto___40258 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___40258)){
var sense_40259 = temp__5720__auto___40258;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40259)].join('');
} else {
}
}
} else {
